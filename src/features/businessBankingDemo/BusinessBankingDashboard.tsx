        ...
        title={
          <Box>
            ...
            <Typography variant="caption" sx={{ color: TEXT_MUTED, display: 'block', mt: 0.2 }}>
              Terakhir masuk: 30 Desember 2024 11:35
            </Typography>
          </Box>
        }
        actions={
        ...
        extra={
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <Box sx={{ zIndex: 1 }}>
                <Typography variant="caption" sx={{ color: TEXT_MUTED, fontWeight: 600, fontSize: '0.75rem' }}>
                  Minggu, 31 Nov 2024 &nbsp; <strong>04:05 WIB</strong>
                </Typography>
                <Typography variant="h6" sx={{ fontWeight: 800, color: TEXT_MAIN, mt: 0.5, lineHeight: 1.2 }}>
                  15 menit
                </Typography>
              ...
              {/* Decorative Mosque Dome graphic artwork background */}
              <Box
                sx={{
                  width: 64,
                  height: 64,
              ...
              >
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M12 3C10.5 5 8 8 8 11V18H16V11C16 8 13.5 5 12 3Z"
                    fill="#00A99D"
                  />
                  <path
                    d="M12 2C12.5 2 13 2.5 13 3C13 3.5 12.5 4 12 4C11.5 4 11 3.5 11 3C11 2.5 11.5 2 12 2Z"
                    fill="#EAA827"
                  />
                  <path
                    d="M6 18H18V21H6V18Z"
